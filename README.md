...
|---|--------|--------|-----------:|---------:|-------|
| 0 | Baseline GPT-2 (LayerNorm, learned PE, ReLU FFN, MHA) | ✅ | **1.3548** | **1.5787** | Reference point — 817K params |
| 1 | `LayerNorm` → **RMSNorm** | ⬜ Phase 2 | – | – | LLaMA-style, no mean subtraction |
